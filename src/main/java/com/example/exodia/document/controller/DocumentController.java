...
public class DocumentController {
	...
	public ResponseEntity<?> uploadFile(@RequestPart(value = "file")  MultipartFile file, @RequestPart(value = "data") DocReqDto docReqDto) {
		try {
			documentService.saveFile(file, docReqDto);
