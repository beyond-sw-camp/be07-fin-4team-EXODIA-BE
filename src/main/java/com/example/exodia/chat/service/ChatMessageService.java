...
public class ChatMessageService {
    ...
    public void sendMessage(ChatMessageRequest chatMessageRequest){
        // 보낸 사람
        User user = userRepository.findByUserNumAndDelYn(chatMessageRequest.getUserNum(), DelYN.N).orElseThrow(()->new EntityNotFoundException("없는 사원입니다"));
        // 채팅방
